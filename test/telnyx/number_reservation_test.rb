...
module Telnyx
  class NumberReservationTest < Test::Unit::TestCase
    should "be listable" do
      ...
      assert_requested :get, "#{Telnyx.api_base}/number_reservations"
    ...
    should "call extend" do
      ...
      stub = stub_request(:post, "#{Telnyx.api_base}/number_reservations/#{number_reservation.id}/actions/extend")
