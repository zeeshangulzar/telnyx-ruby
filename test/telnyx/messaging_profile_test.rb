...
module Telnyx
  class MessagingProfileTest < Test::Unit::TestCase
    ...
    should "be retrievable" do
      messaging_profile = Telnyx::MessagingProfile.retrieve("7d8f749f-d825-9887-26c1-d52f1008c6a9")
      # assert_requested :get, "#{Telnyx.api_base}/messaging_profiles/#{messaging_profile.id}"
      assert messaging_profile.is_a?(Telnyx::MessagingProfile)
    end

    should "be creatable" do
      messaging_profile = Telnyx::MessagingProfile.create(name: "Foo")
      assert_requested :post, "#{Telnyx.api_base}/messaging_profiles"
      assert messaging_profile.is_a?(Telnyx::MessagingProfile)
    end
    ...
    should "be saveable" do
      ...
      messaging_profile = Telnyx::MessagingProfile.retrieve("7d8f749f-d825-9887-26c1-d52f1008c6a9")
      stub = stub_request(:patch, "#{Telnyx.api_base}/messaging_profiles/#{messaging_profile.id}")
    ...
    should "be updatable" do
      # stub out save until number_pool_settings issue is worked out
      stub = stub_request(:patch, "#{Telnyx.api_base}/messaging_profiles/123")
             .with(body: hash_including(name: "foo"))
             .to_return(body: JSON.generate(data: MessagingProfile.retrieve("7d8f749f-d825-9887-26c1-d52f1008c6a9")))
    ...
    should "be deletable" do
      ...
      assert_requested :delete, "#{Telnyx.api_base}/messaging_profiles/#{messaging_profile.id}"
      assert messaging_profile.is_a?(Telnyx::MessagingProfile)
    end
    ...
    should "be able to list PhoneNumbers" do
      ...
      # assert_requested :get, "#{Telnyx.api_base}/messaging_profiles/123/phone_numbers"
    ...
    should "be able to list alphanumeric sender ids" do
      ...
      assert_requested :get, "#{Telnyx.api_base}/messaging_profiles/123/alphanumeric_sender_ids"
